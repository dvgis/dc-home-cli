  ...
  <div class="info">
    ...
    <div class="module">
      ...
      <div class="module_desc">
        <h2>文档简单 + 方便使用</h2>
        <div class="desc">
          平台使用一目了然，容易学习，无论是 API
          还是文档，都具有很强的可读性、自学习性。平台支持多种方式导入使用过，同时提供大量的示例演示，方便开发者快速构建3D
          Gis应用。
        </div>
      </div>
    </div>
    <div class="module">
      <div class="module_desc">
        <h2>敏捷开发 + 扩展便捷</h2>
        <div class="desc">
          平台内部设计合理，采用标准的开发模式。平台提供基本的开发类，支持后期的二次开发，方便用户实现自定义模块或组件。
        </div>
      </div>
    ...
    <div class="module">
      ...
      <div class="module_desc">
        <h2>多平台支持 + 完整解决方案</h2>
        <div class="desc">
          平台支持多种终端的使用，用户无需安装任何插件，直接可在浏览器中对三维场景的浏览。<br />
        </div>
      </div>
    </div>
  </div>
